...
// Config
import { componentModule } from 'temp/component-factory';
import config from 'temp/config';
import packageJson from 'package.json';
// Local
import type { SitecorePageProps, ExtendedLayoutServiceData } from './page-props';
  ...
  public async create(
    ...
    if (context.preview) {
      ...
      const data = await editingDataService.getEditingData(
        // Next 11 Fix, Get[Static|Server]PropsContext.previewData type has changes to PreviewData from any.
        // https://github.com/Sitecore/jss/issues/726
      ...
      layoutData = data.layoutData as ExtendedLayoutServiceData;

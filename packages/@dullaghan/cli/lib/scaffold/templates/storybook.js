...
export const storybook = ({ name, subdirectory, hasGetStaticProps, hasPlaceholder, }) => {
    /**
     * Imports
     */
    const imports = {
    ...
    if (hasGetStaticProps) {
        ...
        imports.local.push(`import ${MOCK_DATA_DEFAULT}, { ${MOCK_DATA_STATIC_PROPS} } from './${name}.mock-data';`);
    }
    else {
